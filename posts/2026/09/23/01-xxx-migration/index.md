...
ご隠居サーバーのPostgreSQLのバックアップにはpgBackRestを使っています（[以前紹介したpg_rman](https://blog.azyobuzi.net/2022/12/31/01-pgrman/)から移行しました）。定期的なフルバックアップとWALアーカイブをBackblaze B2にアップロードしており、基本的には障害が起きても失われるデータは数分程度となっています。
